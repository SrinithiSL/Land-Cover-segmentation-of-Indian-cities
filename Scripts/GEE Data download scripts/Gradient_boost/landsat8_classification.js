...
var india = ee.FeatureCollection('users/SrinithiSL/India_Boundary')
    .geometry();
...
var ft = ee.FeatureCollection('users/SrinithiSL/IndiaSat');
...
var trained = ee.Classifier.smileGradientTreeBoost(10).train(training, 'class', new_bands);
...
var aoi_name = aoi_list[i];
  for (var j in year_list)
  {
    ...
    var aoi = aoi_list[j];
    var aoi = ee.FeatureCollection('users/SrinithiSL/india_district_boundaries')
